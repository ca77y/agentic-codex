...
- Dispatch execution evidence/classification, independently available host settings/source, diagnosis/escalation, and correction required before retry. For a dispatch fault or uncertain execution, read [dispatch fault recovery](dispatch.md); preserve unresolved reservations and do not turn a missing report into proof of no work.
