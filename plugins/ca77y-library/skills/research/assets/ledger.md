...
- Submitted model / effort / selection rationale:
- Dispatch execution evidence / classification: <started / proven pre-work fault / uncertain / not applicable; evidence link>
- Host-reported effective model: <value or unavailable>
- Host-reported session-versus-disk source: <value or unavailable, independently of effective model>
- Diagnosis / escalation / required correction before retry:
- Effect on failure count / reservation and reconciliation:
