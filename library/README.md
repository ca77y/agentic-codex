...
A Markdown-first research wiki for agentic-codex. It stores research memory and source provenance, not implementation authority. It is Obsidian-compatible — internal navigation uses wikilinks and backlinks, which resolve when the repository is opened as a vault and read as plain Markdown when it isn't.
